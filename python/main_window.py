...
class MainWindow(QtWidgets.QMainWindow, design.Ui_MainWindow):
    def __init__(self):
        ...
        self.startAir.clicked.connect(self.air_start)
        self.StopAir.clicked.connect(self.air_stop)
    ...
    def database(self):
        try:
            ...
            if connection.is_connected():
                ...
                sql = "INSERT INTO mc_database.room (temperature, humidity, air_conditioning) VALUES (%s, %s, %s)"
                print(sql)
